...
final eventsRepositoryProvider = Provider<EventsRepository>((ref) {
  ...
  final organizerId = switch (authState) {
    AuthAuthenticated(session: OrganizerSession(:final userId))
        when userId.trim().isNotEmpty =>
      userId,
    _ => FakeEventsRepository.defaultOrganizerId,
  };

  return FakeEventsRepository(organizerId: organizerId);
});
