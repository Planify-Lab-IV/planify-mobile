...
import 'package:planify/features/expenses/presentation/widgets/expense_debtor_selector.dart';
...
void main() {
  ...
  testWidgets('muestra un selector por participante, sin campos de monto', (
    ...
    expect(find.text('¿Quiénes deben?'), findsOneWidget);
    ...
    expect(
      find.byKey(const Key('expense_debtor_selector_participant-juan')),
      findsOneWidget,
    );
